...
![城市街谷](Docs/Images/city_street_v5.png)

> 上图:模块 11「要地防御战」城市街区实拍级取景帧 —— 16m 机位沿主干道平视,22~64m 幕墙塔楼组成街谷天际线,程序生成窗格幕墙(窗框/玻璃天光渐变/楼层线)、商业裙楼与檐口压顶、低角度暖阳长影、车道标线/停车/斑马线,全部由代码生成,无任何建模资产。
...
| V5 实景级美化 | 程序生成幕墙贴图(浅亮窗框+深玻璃天光渐变+楼板投影线,格间明暗抖动;夜间同格对位窗光发光贴图)、真街谷尺度塔楼(22~64m 天际线)、商业裙楼/檐口压顶/屋顶空调外机/设备间/水箱/天线、34° 低角度暖阳长影、云层 billboard、全贴图三线性+各向异性过滤(掠射角窗格不糊)、无头截帧 2× 超采样 |
...
| 黄昏(V5 实景) | 夜幕降临(V5:点光+窗光) |
|---|---|
| ![黄昏](Docs/Images/env_dusk_v5.png) | ![夜幕](Docs/Images/env_night_v5.png) |
...
| 要地防御战(EMP 冻结+弹幕齐射) | 城市街谷(22~64m 幕墙塔楼) |
|---|---|
| ![要地防御战](Docs/Images/battle_defense_v5.png) | ![城市街区](Docs/Images/city_street_v5.png) |

> 截图均为 `-batchmode` 无头渲染帧(2× 超采样 1280×720),不含 IMGUI 界面(HUD/侧板请在编辑器 Play 查看)。
